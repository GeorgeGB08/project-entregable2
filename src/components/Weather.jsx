  ...
  return (
    ...
    <section className='grid gap-4 sm:grid-cols-two'>
     ...
     <article className='bg-slate-300/70 rounded-3xl grid grid-cols-2 justify-items-center items-center py-2 sm:px-2 '>
      ...
      <h2 className='text-[45px] font-light sm: text-6xl'>{ isCelsius ? `${temp.celcius} °C` : `${temp.fahrenheit} °F`} </h2>
    ...
    <button onClick={changeUnitTemp} className='bg-blue-500 py-2 px-3 text-white font-bold  rounded-full hover:bg-blue-900 duration-200 text-sm block mx-auto mt-4'>Change °C/°F</button>
